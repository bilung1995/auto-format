...
def main_menu(user_id=None):
    ...
    # 2 kolom profesional - TOP UP emas muda + hijau sesuai request user
    # Warna background asli hanya bisa di WebApp, di Inline pakai emoji 🟡🟢🔵
    rows = [
        [
        ...
        [
            InlineKeyboardButton(text="✨ MENU WARNA", callback_data="menu_warna")
        ]
    ]
...
async def menu_warna(callback: CallbackQuery):
    await callback.message.answer(
        "🎨 <b>MENU PROFESIONAL - WARNA EMAS MUDA & HIJAU</b>\n\n"
        "Di Telegram, tombol Inline tidak bisa berwarna background (limitasi API Telegram).\n\n"
        "✅ <b>Solusi Profesional:</b>\n"
        "1. Pakai <b>WebApp / Mini App</b> - bisa warna emas #FDE68A & hijau #22C55E beneran\n"
        "2. Preview ada di file html yang aku kirim\n\n"
        "🟡 <b>TOP UP = Emas Muda</b> - premium\n"
        "🟢 <b>Beli Credit = Hijau</b> - sukses\n"
        "🔵 <b>Lainnya = Biru Muda</b> - profesional",
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            [InlineKeyboardButton(text="🟡💳 TOP UP (Emas)", callback_data="topup")],
