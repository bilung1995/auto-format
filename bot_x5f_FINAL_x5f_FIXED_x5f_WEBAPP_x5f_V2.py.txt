...
def main_menu(user_id=None):
    ...
    # FULL 2 KOTAK + WEBAPP WARNA EMAS ASLI - URL: https://golden-pastelito-feec0f.netlify.app
    rows = [
        [
        ...
        [
            InlineKeyboardButton(text="✨ MENU WARNA EMAS", web_app=WebAppInfo(url="https://golden-pastelito-feec0f.netlify.app")),
