...
from aiogram.types import CallbackQuery, InlineInlineKeyboardButton, InlineKeyboardMarkup, Message
...
def main_menu(user_id=None):
    ...
    rows = [
        [InlineInlineKeyboardButton(text="👤 PROFIL USER", callback_data="profile")],
        [InlineInlineKeyboardButton(text="💳 TOP UP", callback_data="topup")],
        [InlineInlineKeyboardButton(text="📊 CEK STATUS", callback_data="status")],
        [InlineInlineKeyboardButton(text="💡 SOLUSI JMO", callback_data="solusi_jmo")],
        [InlineInlineKeyboardButton(text="📝 AUTO FORMAT", callback_data="auto_format")],
        [InlineInlineKeyboardButton(text="📞 HUBUNGI ADMIN", callback_data="contact_admin")],
        [InlineInlineKeyboardButton(text="ℹ️ INFO BOT", callback_data="info_bot")],
    ]
    if is_admin(user_id):
        rows.append([InlineInlineKeyboardButton(text="🔐 PANEL ADMIN", callback_data="admin_panel")])
        rows.append([InlineInlineKeyboardButton(text="⬅️ MENU UTAMA", callback_data="back_main")])
...
def back_main():
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineInlineKeyboardButton(text="⬅️ KEMBALI KE MENU UTAMA", callback_data="back_main")]
    ])
...
def auto_menu():
    ...
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineInlineKeyboardButton(text="📝 BUAT FORMAT", callback_data="format_create")],
        [InlineInlineKeyboardButton(text="📄 HASIL TERKINI", callback_data="format_results")],
        [InlineInlineKeyboardButton(text="📧 HASIL FORMAT+AKUN", callback_data="hasil_akun")],
        [InlineInlineKeyboardButton(text="⚙️ SETTING FORMAT", callback_data="format_setting")],
        [InlineInlineKeyboardButton(text="🕘 RIWAYAT", callback_data="format_history")],
        [InlineInlineKeyboardButton(text="💳 TOP UP", callback_data="topup")],
        [InlineInlineKeyboardButton(text="📊 STATUS", callback_data="status")],
        [InlineInlineKeyboardButton(text="⬅️ MENU UTAMA", callback_data="back_main")]
    ])


def admin_menu():
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineInlineKeyboardButton(text="👥 CEK USER AKTIF", callback_data="admin_active")],
        [InlineInlineKeyboardButton(text="💰 LIHAT TRANSAKSI PENDING", callback_data="admin_pending")],
        [InlineInlineKeyboardButton(text="➕ TAMBAH SALDO USER", callback_data="admin_add_balance")],
        [InlineInlineKeyboardButton(text="➖ KURANGI SALDO USER", callback_data="admin_sub_balance")],
        [InlineInlineKeyboardButton(text="🗑️ HAPUS DATA USER", callback_data="admin_delete_user")],
        [InlineInlineKeyboardButton(text="📢 KIRIM BROADCAST KE USER", callback_data="admin_broadcast")],
        [InlineInlineKeyboardButton(text="⬅️ KEMBALI KE MENU UTAMA", callback_data="back_main")]
    ])
...
async def cmd_autoformat(message: Message, state: FSMContext):
    await state.clear()
    from aiogram.types import InlineInlineKeyboardButton, InlineKeyboardMarkup
    if has_auto_format_access(message.from_user.id):
        ...
        await message.answer(
            ...
            reply_markup=InlineKeyboardMarkup(inline_keyboard=[
                [InlineInlineKeyboardButton(text="🟢 PAKET 6 BULAN — Rp50.000", callback_data="af_6m")],
                [InlineInlineKeyboardButton(text="🔵 PAKET 1 TAHUN — Rp80.000", callback_data="af_1y")],
                [InlineInlineKeyboardButton(text="🟣 PAKET UNLIMITED — Rp200.000", callback_data="af_unlimited")],
                [InlineInlineKeyboardButton(text="⬅️ KEMBALI KE MENU UTAMA", callback_data="back_main")]
            ])
        )
...
async def topup_amount(message: Message, state: FSMContext):
    ...
    await message.answer(
        ...
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            [InlineInlineKeyboardButton(text="✅ SUDAH BAYAR", callback_data="payment_done")],
            [InlineInlineKeyboardButton(text="❌ BATAL", callback_data="back_main")]
        ])
    )
...
async def auto_package(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.edit_text(
        ...
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            [InlineInlineKeyboardButton(text="✅ SUDAH BAYAR", callback_data="payment_done")],
            [InlineInlineKeyboardButton(text="⬅️ KEMBALI", callback_data="auto_format")]
        ])
    )
    await callback.answer()
...
async def payment_proof(message: Message, state: FSMContext):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[[
        InlineInlineKeyboardButton(text="✅ SETUJU", callback_data=f"approve_{tx_id}"),
        InlineInlineKeyboardButton(text="❌ TOLAK", callback_data=f"reject_{tx_id}")
    ]])
...
async def solusi_start(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.edit_text(
        ...
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            [InlineInlineKeyboardButton(text="❓ SOLUSI ERROR 025", callback_data="jmo_025")],
            [InlineInlineKeyboardButton(text="❓ SOLUSI ERROR 026", callback_data="jmo_026")],
            [InlineInlineKeyboardButton(text="❓ SOLUSI ERROR 029 (WAJAH)", callback_data="jmo_029")],
            [InlineInlineKeyboardButton(text="❓ CARA CAIRKAN JHT", callback_data="jmo_jht cair")],
            [InlineInlineKeyboardButton(text="⬅️ KEMBALI KE MENU UTAMA", callback_data="back_main")]
        ])
    )
    await callback.answer()
    ...
    for key, data in JMO_SOLUTIONS.items():
        if key == error_code:
            await callback.message.edit_text(
                data["solution"],
                reply_markup=InlineKeyboardMarkup(inline_keyboard=[
                    [InlineInlineKeyboardButton(text="🔄 KEMBALI KE MENU SOLUSI", callback_data="solusi_jmo")],
                    [InlineInlineKeyboardButton(text="⬅️ KEMBALI KE MENU UTAMA", callback_data="back_main")]
                ])
            )
            await callback.answer()
...
async def solusi_text(message: Message, state: FSMContext):
    ...
    await message.answer(
        solution,
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            [InlineInlineKeyboardButton(text="🔄 TANYA LAGI", callback_data="solusi_jmo")],
            [InlineInlineKeyboardButton(text="⬅️ KEMBALI KE MENU UTAMA", callback_data="back_main")]
        ])
    )
...
async def solusi_photo(message: Message, state: FSMContext):
    ...
    if caption:
        ...
        await message.answer(
            ...
            reply_markup=InlineKeyboardMarkup(inline_keyboard=[
                [InlineInlineKeyboardButton(text="🔄 KETIK MASALAH", callback_data="solusi_jmo")],
                [InlineInlineKeyboardButton(text="⬅️ KEMBALI KE MENU UTAMA", callback_data="back_main")]
            ])
        )
...
async def format_create(callback: CallbackQuery):
    ...
    await callback.message.edit_text(
        ...
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            [InlineInlineKeyboardButton(text="⌨️ KETIK DATA MANUAL", callback_data="format_manual")],
            [InlineInlineKeyboardButton(text="📊 UPLOAD FILE EXCEL (.xlsx)", callback_data="format_excel")],
            [InlineInlineKeyboardButton(text="⬅️ KEMBALI KE MENU AUTO FORMAT", callback_data="auto_format")]
        ])
    )
    await callback.answer()
...
async def format_manual_receive(message: Message, state: FSMContext):
    ...
    await message.answer(
        ...
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            [InlineInlineKeyboardButton(text="📋 SALIN HASIL FORMAT", callback_data=f"copy_result_{result_id}")],
            [InlineInlineKeyboardButton(text="📋 SALIN SEMUA HASIL", callback_data=f"copy_all_{result_id}")],
            [InlineInlineKeyboardButton(text="✏️ EDIT HASIL FORMAT", callback_data=f"edit_result_{result_id}")],
            [InlineInlineKeyboardButton(text="🗑️ HAPUS HASIL FORMAT", callback_data=f"delete_result_{result_id}")],
            [InlineInlineKeyboardButton(text="💾 SIMPAN KE HISTORY", callback_data=f"save_result_{result_id}")],
            [InlineInlineKeyboardButton(text="⬅️ KEMBALI KE MENU AUTO FORMAT", callback_data="auto_format")]
        ])
    )
...
async def format_setting(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.edit_text(
        ...
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            [InlineInlineKeyboardButton(text="🔢 SET KODE FORMAT", callback_data="set_kode_format")],
            [InlineInlineKeyboardButton(text="❌ HAPUS KODE", callback_data="delete_kode_format")],
            [InlineInlineKeyboardButton(text="⬅️ KEMBALI KE MENU UTAMA", callback_data="back_main")]
        ])
    )
    await callback.answer()
...
async def set_kode_format(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.edit_text(
        ...
        "Ketik kode sekarang:",
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            [InlineInlineKeyboardButton(text="⬅️ BATAL", callback_data="format_setting")]
        ])
    )
    await callback.answer()
...
async def receive_kode_format(message: Message, state: FSMContext):
    ...
    await message.answer(
        ...
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            [InlineInlineKeyboardButton(text="⚙️ LIHAT SETTING", callback_data="format_setting")],
            [InlineInlineKeyboardButton(text="📝 BUAT FORMAT", callback_data="format_create")]
        ])
    )
...
async def delete_kode_format(callback: CallbackQuery):
    ...
    await callback.message.edit_text(
        ...
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            [InlineInlineKeyboardButton(text="⚙️ KEMBALI KE SETTING", callback_data="format_setting")]
        ])
    )
    await callback.answer()
...
async def format_excel_receive(message: Message, state: FSMContext):
    ...
    await message.answer(
        ...
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            [InlineInlineKeyboardButton(text="📋 SALIN SEMUA HASIL", callback_data=f"copy_all_{rid}")],
            [InlineInlineKeyboardButton(text="💾 SIMPAN KE HISTORY", callback_data=f"save_result_{rid}")],
            [InlineInlineKeyboardButton(text="⬅️ KEMBALI KE MENU AUTO FORMAT", callback_data="auto_format")]
        ])
    )
...
async def format_search(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.edit_text(
        ...
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            [InlineInlineKeyboardButton(text="⬅️ KEMBALI KE MENU HASIL FORMAT", callback_data="format_results")]
        ])
    )
    await callback.answer()
...
async def format_search_receive(message: Message, state: FSMContext):
    ...
    if not rows:
        await message.answer(
            ...
            reply_markup=InlineKeyboardMarkup(inline_keyboard=[
                [InlineInlineKeyboardButton(text="🔎 CARI LAGI", callback_data="format_search")],
                [InlineInlineKeyboardButton(text="📄 LIHAT SEMUA", callback_data="format_results")]
            ])
        )
        return
    ...
    for row in rows:
        ...
        await message.bot.send_message(
            ...
            reply_markup=InlineKeyboardMarkup(inline_keyboard=[
                [
                    InlineInlineKeyboardButton(text="📋 SALIN", callback_data=f"copy_result_{rid}"),
                    InlineInlineKeyboardButton(text="🗑️ HAPUS", callback_data=f"delete_result_{rid}"),
                    InlineInlineKeyboardButton(text="✏️ EDIT", callback_data=f"edit_result_{rid}")
                ]
            ])
        )
...
async def search_akun_do(message: Message, state: FSMContext):
    ...
    for r in rows:
        kb = InlineKeyboardMarkup(inline_keyboard=[[InlineInlineKeyboardButton(text="📋 Salin", callback_data=f"copy_akun_{r['id']}"), InlineInlineKeyboardButton(text="🗑️ Hapus", callback_data=f"del_akun_{r['id']}")]])
...
async def menu_warna(callback: CallbackQuery):
    await callback.message.answer(
        ...
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            [InlineInlineKeyboardButton(text="🟡 TOP UP", callback_data="topup")],
            [InlineInlineKeyboardButton(text="⬅️ KEMBALI", callback_data="back_main")]
        ])
    )
    await callback.answer()
...
async def format_history(callback: CallbackQuery):
    ...
    if not rows:
        await callback.message.bot.send_message(
            ...
            reply_markup=InlineKeyboardMarkup(inline_keyboard=[
                [InlineInlineKeyboardButton(text="📄 LIHAT HASIL FORMAT", callback_data="format_results")],
                [InlineInlineKeyboardButton(text="⬅️ MENU AUTO FORMAT", callback_data="auto_format")]
            ])
        )
        await callback.answer()
        return
    ...
    await callback.message.bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            [InlineInlineKeyboardButton(text="🗑️ HAPUS SEMUA RIWAYAT", callback_data="clear_history")],
            [InlineInlineKeyboardButton(text="📄 LIHAT HASIL FORMAT", callback_data="format_results")]
        ])
    )
    ...
    for r in rows:
        ...
        await callback.message.bot.send_message(
            ...
            reply_markup=InlineKeyboardMarkup(inline_keyboard=[
                [
                    InlineInlineKeyboardButton(text="♻️ PULIHKAN", callback_data=f"restore_history_{rid}"),
                    InlineInlineKeyboardButton(text="🗑️ HAPUS PERMANEN", callback_data=f"delete_history_{rid}")
                ]
            ])
        )
        await asyncio.sleep(0.1)
...
async def restore_history(callback: CallbackQuery):
    ...
    await callback.message.bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            [InlineInlineKeyboardButton(text="📄 LIHAT HASIL FORMAT", callback_data="format_results")],
            [InlineInlineKeyboardButton(text="🕘 LIHAT RIWAYAT", callback_data="format_history")]
        ])
    )
...
async def contact_admin(callback: CallbackQuery):
    await callback.message.edit_text(
        ...
        "083160776091",
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            [InlineInlineKeyboardButton(text="💬 CHAT TELEGRAM", url="https://t.me/Hambali1995")],
            [InlineInlineKeyboardButton(text="📱 CHAT WHATSAPP", url="https://wa.me/6283160776091")],
            [InlineInlineKeyboardButton(text="⬅️ KEMBALI KE MENU UTAMA", callback_data="back_main")]
        ])
    )
    await callback.answer()
...
async def admin_pending(callback: CallbackQuery):
    ...
    for row in rows:
        keyboard = InlineKeyboardMarkup(inline_keyboard=[[
            InlineInlineKeyboardButton(text="✅ SETUJU", callback_data=f"approve_{row['id']}"),
            InlineInlineKeyboardButton(text="❌ TOLAK", callback_data=f"reject_{row['id']}")
        ]])
        caption = (
            "💰 <b>TRANSAKSI PENDING</b>\n\n"
...
async def admin_broadcast_start(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.edit_text(
        ...
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            [InlineInlineKeyboardButton(text="❌ BATAL", callback_data="admin_cancel")]
        ])
    )
    await callback.answer()
